    ...
    for n, q in enumerate(question_context_map):
        if len(question_context_map[q])>1:
            ...
            for m, c in enumerate(question_context_map[q]):
                ...
                with open(os.path.join(source_path, new_id), 'w', encoding='utf-8') as wr:  # utf-8
                    wr.writelines(c + "\n")
